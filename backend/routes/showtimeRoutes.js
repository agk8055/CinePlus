...
router.get('/theaters/:theaterId', authenticateJWT, authorizeTheatreAdmin, showtimeController.getShowtimesByTheater); // Kept for potential admin/public access - with theaterId in path
